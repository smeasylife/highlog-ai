...
2. 질문은 생활기록부 내용에 실제로 적힌 활동 하나를 중심으로 작성하세요.
3. 질문은 한 문장으로 짧게 쓰고, 활동 하나와 확인할 점 하나만 물어보세요.
4. 생활기록부에 명확히 있는 내용만 근거로 삼고, 없는 활동이나 세부사항을 만들지 마세요.
5. 실제 면접 질문 예시의 스타일과 난이도는 참고하되 문장을 그대로 복사하지 마세요.
6. 고등학생이 학생부 활동과 고등학교 수준의 배경지식으로 답할 수 있는 범위를 넘지 마세요.
7. 심화/압박 질문도 대학 전공 지식을 요구하는 질문이 아니라, 학생부 활동의 원리·과정·판단 이유 중 하나만 묻는 수준으로 작성하세요.
8. 각 질문에 대해 질문 목적, 모범 답안, 답변 포인트, 평가 기준을 제시하세요.
9. purpose 예시 : 학생의 문제 해결 능력 평가, 협동심 평가 등
10. answer_points 예시 : 자료 조사, 경험 사례 제시 등
11. model_answer는 실제 답안처럼 여러 문장으로 구성되어도 좋습니다.
12. evaluation_criteria 예시: STAR 기법 활용, 모범 답안에서 구체적인 사례를 제시함 등
